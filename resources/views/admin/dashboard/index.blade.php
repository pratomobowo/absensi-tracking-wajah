...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('admin.dashboard.attendance') }}" class="bg-white rounded-lg shadow p-6 flex items-center hover:bg-blue-50 transition duration-200">
            <div class="p-3 rounded-full bg-blue-600 bg-opacity-10">
                <svg class="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-gray-800">Attendance Dashboard</h2>
                <p class="text-gray-600">View comprehensive attendance analytics</p>
            </div>
        </a>
        
        <a href="{{ route('admin.employees.index') }}" class="bg-white rounded-lg shadow p-6 flex items-center hover:bg-blue-50 transition duration-200">
            <div class="p-3 rounded-full bg-green-600 bg-opacity-10">
                <svg class="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-gray-800">Manage Employees</h2>
                <p class="text-gray-600">View and manage employee data</p>
            </div>
        </a>
        
        <a href="{{ route('admin.reports.daily') }}" class="bg-white rounded-lg shadow p-6 flex items-center hover:bg-blue-50 transition duration-200">
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-gray-800">Attendance Reports</h2>
                <p class="text-gray-600">Generate detailed attendance reports</p>
            </div>
        </a>
    </div>
